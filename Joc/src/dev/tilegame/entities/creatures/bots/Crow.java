...
public class Crow extends Creature {
    ...
    private int damage_power = 3;
    private int score_plus = 7;
    private boolean clean_on_next_level = true;

    public Crow(Handler handler, float x, float y,int raza_patrulare,float custom_speed) {
        ...
        animStop = new Animation(100, Assets.crow_move_right);
        animMoveLeft = new Animation(100, Assets.crow_move_left);
        animMoveRight = new Animation(100, Assets.crow_move_right);

        animAttackRight = new Animation(100, Assets.crow_attack_right);
        animAttackLeft = new Animation(100, Assets.crow_attack_left);
