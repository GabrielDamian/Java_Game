...
public class PurpleWizard extends Creature {
    ...
    private int damage_power = 5;
    private int score_plus = 10;

    private boolean clean_on_next_level = true;

    public PurpleWizard(Handler handler, float x, float y,int raza_patrulare,float custom_speed) {
        ...
        animStop = new Animation(100, Assets.purpleWizar_move_right);

        animMoveLeft = new Animation(200, Assets.purpleWizar_move_left);
        animMoveRight = new Animation(200, Assets.purpleWizar_move_right);

        animAttackRight = new Animation(100, Assets.purpleWizard_attack_right);
        animAttackLeft = new Animation(100, Assets.purpleWizard_attack_left);
