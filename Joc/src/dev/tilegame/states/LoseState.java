...
public class LoseState extends State{
    ...
    public LoseState(Handler handler) {
        ...
        uiManager.addObject(new UIImageButton((int)((int)handler.getGame().getWidth()/2)-30, (int)((int)handler.getGame().getHeight()/2)+220, 48, 19, Assets.btn_Back, new ClickListener() {
            @Override
            public void onClick() {
    ...
    public void render(Graphics g) {
        handler.getGame().getGraphics().drawImage(Assets.loseState,0,0,null,null);
        uiManager.render(g);
        g.setColor(Color.red);
        g.drawString(Integer.toString(handler.getGame().getScore()),380,527);
